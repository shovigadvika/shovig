    ...
    >
      ...
      <div className="relative z-20 max-w-3xl px-[64px] text-center flex flex-col items-center justify-center">
        ...
        <p className="text-base md:text-lg text-gray-900 max-w-2xl mt-6">
          We create intelligent systems that automate tasks, analyze data, and
          deliver smarter customer experiences — built with cutting-edge
          algorithms and human-centric design.
        </p>
      </div>
    </section>
  );
